...
eventOffers:
  url: 'https://www.eztravel.com.tw/activity/taitungballoon/'
  free: true
  currency: TWD
...
Bring a hat and water even for a dawn visit; by mid-morning in July and August, the highland sun is already strong.
...
Cash is still useful at the food stalls and vendor tents around the field even as mobile and card payment spreads across Taiwan, so carry some small bills. The single most common visitor mistake is showing up mid-morning expecting balloons still aloft — by then the wind has usually picked up and the launch window has closed, so treat sunrise as the real start time, not a bonus.

If you want the tethered ride or a spot at a Night Glow session, check ticketing details in advance rather than assuming walk-up availability, and always verify the current year's exact launch times, ticket prices, and Chiikawa-balloon dates on the official festival channel, since all of these are set closer to the season and can shift.
