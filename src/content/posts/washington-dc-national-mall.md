...
Spring (late March–April) brings cherry blossoms around the Tidal Basin but also the heaviest crowds; fall (September–October) offers similar mild weather with far fewer tourists. Summer is hot and humid with little shade on the open lawn, so mornings before 10am or evenings after 6pm are far more comfortable. The memorials are illuminated and open 24 hours, and visiting Lincoln or the WWII Memorial after dark is a genuinely different, quieter experience than the midday crush.
