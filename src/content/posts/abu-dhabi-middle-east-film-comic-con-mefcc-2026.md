...
eventRecurring: true
eventVenue: ADNEC Centre Abu Dhabi
eventOrganizer:
...
MEFCC isn't a small fan meetup bolted onto a mall atrium. It's the largest pop-culture convention in the Middle East, now in its 14th edition, drawing cosplayers, voice actors, comic artists and gaming studios from across the Gulf and beyond. Walk the main hall and you'll pass a cosplay stage on one side, a wall of independent comic artists sketching commissions on the other, and a wash of announcer audio bleeding in from an esports tournament somewhere behind a curtain.
...
- Gaming zones with the latest console and PC setups plus esports matches
