...
Two main halls anchor the visit: textile machinery and automobile technology, arranged in roughly chronological order so you watch the transformation from loom-maker to carmaker unfold room by room.

Highlights include:

- Sakichi Toyoda's original automatic looms, several demonstrated live by museum staff on a set schedule
- Early Toyota prototype vehicles and engines, including pieces tracing the shift from textile machinery to automotive parts
...
This is a genuinely popular stop on the Nagoya circuit, not a quiet insider find, so the smart move is timing rather than avoidance.
