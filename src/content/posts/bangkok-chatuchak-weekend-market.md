...
description: >-
  Chatuchak Weekend Market (locally \"JJ Market\") sprawls across 27 sections
  and over 15,000 stalls in northern Bangkok, open mainly Saturday and Sunday
country: Thailand
region: Bangkok
category: hidden-gem
...
heroImage:
  url: >-
    https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Chatuchak_Weekend_Market%2C_Bangkok%2C_Thailand_%284570440063%29.jpg/1920px-Chatuchak_Weekend_Market%2C_Bangkok%2C_Thailand_%284570440063%29.jpg
  credit: 'Photo: yeowatzup / Wikimedia Commons (CC BY 2.0)'
  license: wikimedia
  source: >-
    https://commons.wikimedia.org/wiki/File:Chatuchak_Weekend_Market,_Bangkok,_Thailand_(4570440063).jpg
gallery: []
place:
...
Chatuchak is organized into loosely themed sections, and knowing a few numbers helps enormously:

- **Sections 2–4**: plants, garden tools, and pottery — good for browsing even if you're not buying.
- **Sections 5–6**: pets and pet supplies, including exotic species; ethically minded visitors may want to skip this zone.
- **Sections 7, 24, 26**: art, handicrafts, and home décor — look for hill-tribe textiles and hand-carved wood pieces.
- **Section 10**: vintage clothing and denim, a favorite with resellers hunting for old Levi's.
- **Sections 22–23**: books, antiques, and collectibles.
- **Soi 8 and the market's food alleys**: this is where to eat — grilled skewers, boat noodles, mango sticky rice, and coconut ice cream served in the husk. Prices are typically a fraction of what you'd pay in a mall food court, though exact prices shift year to year, so treat any number as a rough guide.

Bargaining is expected almost everywhere except food stalls — start around 20–30% below the asking price and settle in the middle. Cash is still king in most stalls; card readers are more common now but far from universal, so carry Thai baht in small denominations.

## When to go

The market runs primarily **Saturday and Sunday**, roughly 9am to 6pm, though many vendors don't fully open until closer to 10am and some stalls start packing up before official closing time. Arrive **early morning (by 9–10am)** to beat both the crowds and the worst of the midday heat, which can be intense given the market's mostly open-air, corrugated-roof layout with limited airflow. A smaller Wednesday–Thursday session focuses on wholesale plants and is far quieter if you want a low-key preview. Weekday visits otherwise mean most stalls are shuttered.
