...
The museum sits at 9-chōme-1-1 Kita 7 Jōhigashi, about a 10-15 minute walk from JR Sapporo Station's east side. Alternatively, the Sapporo Streetcar or a short taxi ride drops you closer to the entrance if you'd rather not walk with a full stomach afterward.

Look for the brick smokestack visible from several blocks away; it's the easiest landmark. The museum sits within Sapporo Garden Park, so there's green space to wander before or after your visit.
...
- Tasting hall: paid, cash and card generally accepted

## Beating the tour-bus crush

This is one of Sapporo's most-visited attractions, and it shows in the tasting hall on weekends. Large tour groups tend to arrive mid-morning and again after lunch, so the exhibit floors can feel bottlenecked in those windows.

Arriving right at 11:00 AM opening usually beats the first wave of groups. If you'd rather sip in relative quiet, target the last hour or so before the 5:30 PM close, when tour buses have typically moved on.

Ordering at the tasting counter works cafeteria-style: you queue, pick your beer or flight from a posted menu, pay, then carry your own tray to a table. Nobody will walk you through it, so watch the flow for a second before joining the line.

## The tastings, and what to actually order
