...
description: 'UFC Fight Night: Ankalaev vs Rountree Jr was set for July 25, 2026 at Etihad Arena on Yas Island, Abu Dhabi, with a light heavyweight main event.'
...
heroImage:
  url: https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/UFC_Fight_Night_Fiziev_vs._Torres_brand_activation_event_in_Baku_Boulevard_%2832821%29.jpg/1920px-UFC_Fight_Night_Fiziev_vs._Torres_brand_activation_event_in_Baku_Boulevard_%2832821%29.jpg
...
On marquee combat sports weekends, rooms on Yas Island tend to fill faster and at a premium, and the best rates on the island usually go several months ahead of the date.

## What to expect fight week

UFC Fight Night cards typically run a lighter promotional schedule than pay-per-view "numbered" events, but Abu Dhabi cards have historically included an open workout and a ceremonial weigh-in open to the public, often at a hotel or public venue on Yas Island, plus fighter meet-and-greets. Weigh-ins for the actual competitors usually happen the day before the card. None of these ancillary events were confirmed for this particular card at the time of the announcement; UFC's official app and website carried the fight-week schedule of free public events, which are a good way to see fighters up close without a ticket to the main card.
