...
faq:
  ...
  - q: When is the museum quietest?
    a: Weekday evenings between 6pm and 8pm see the fewest visitors. Weekends, especially Saturday between 10am and 8pm, are the busiest window, so aim for opening time (9:30am) or later afternoon if visiting on a Saturday; on Sundays the museum closes at 3pm, so an early visit is best.
