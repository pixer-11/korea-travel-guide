...
Dubai Old City is well-known enough that tour groups now build it into Deira itineraries, so don't expect to have it entirely to yourself. The move locals and residents make is timing: come right at sunrise, before 9am, and you'll get the same alleys with none of the shuffle-along crowd.
