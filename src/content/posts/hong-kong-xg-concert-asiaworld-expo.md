...
description: XG at AsiaWorld-Expo in Hong Kong was set for August 2, 2026. What the show was, plus the venue, transit and ticketing details announced.
country: Hong Kong
region: Hong Kong
category: event
pubDate: '2026-07-29'
...
tags:
  - hong kong
  - event
quickAnswer: XG was set to play AsiaWorld-Expo in Hong Kong on August 2, 2026. Exact showtime, hall and ticket on-sale details had not been pinned down, and XG's own channels (X, Instagram) and the XG/AsiaWorld-Expo ticketing pages were where they were to land. AsiaWorld-Expo sits right beside Hong Kong International Airport and connects directly to Tung Chung via AsiaWorld-Expo Station on the Tung Chung Line, so getting there is straightforward even on a same-day flight.
faq:
  - q: What's the confirmed date for XG at AsiaWorld-Expo?
    a: August 2, 2026 was the announced date for the AsiaWorld-Expo show.
  - q: How do I get to AsiaWorld-Expo from central Hong Kong?
    a: The MTR Tung Chung Line runs to AsiaWorld-Expo Station — a direct stop connected to the venue, typically 45–60 minutes from Central or Kowloon.
  ...
  - q: Where do I buy tickets?
    a: Ticketing for this show had not been finalized. Major AsiaWorld-Expo concerts generally sell through platforms such as Cityline or the artist's designated ticketing partner, often with a fan club presale ahead of the general sale.
  - q: How early should I arrive?
    a: Two to three hours before doors is the usual window at this venue, covering security, merch queues and food, since options inside are limited to concessions.
aiGenerated: true
draft: true
...
The exact set time, doors, seating configuration and ticket tiers weren't locked down. An arena show like this generally runs an opening act or DJ set, then a full production show of around 90 minutes to two hours, with the promoter setting the published times.

Ticket sales for major AsiaWorld-Expo shows typically run through official platforms like Cityline or the artist's designated ticketing partner, with presales sometimes offered to fan club members before the general sale. Given the size of XG's fanbase, tiers for a show like this move quickly once they go live.
...
Concert dates and venues for touring acts can shift. For this run, the announced date was August 2, 2026 at AsiaWorld-Expo, with doors and start time, hall configuration and ticket pricing still to be set by the promoter and the designated ticketing partner.
