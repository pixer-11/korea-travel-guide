...
Most visitors book an all-in package (transfer, boat, permit, lunch) rather than assembling the pieces themselves, mainly because of this permit bottleneck. Life vests are provided and required inside the cave, and helmets with headlamps are issued at the entrance since sections of the ceiling drop low.

## How to visit like a local

Locals and repeat visitors treat the early morning slot as the only one worth angling for — the earliest boat groups get quieter water, better acoustics inside the cave (fewer overlapping guide narrations echoing off the walls), and a shot at seeing more wildlife on the Monkey Trail before midday heat sets other tours moving. Since this is a well-visited, high-demand park rather than a hidden spot, the real local knowledge is about avoiding the crush: book your permit slot well in advance, ask your operator to confirm the earliest possible departure, and skip weekends and Philippine holiday periods if your schedule allows.

Payment for tours and boat transfers in Sabang is typically cash-based in Philippine pesos, so carry small bills rather than relying on cards. Follow the no-flash-photography and no-touching-formations etiquette your guide states at the outset — it's enforced, and it's also simply what keeps a million-year-old cave system intact for the next visitor.
