...
With a 4.5 rating across roughly 7,650 reviews, it's one of the most consistently praised restaurants in the city, and it draws both locals marking special occasions and travelers making a specific pilgrimage for the dish.

## Getting there

The honten sits at 503 Gōdochō, Atsuta Ward, Nagoya — a few minutes' walk from Atsuta Jingu, one of Japan's most important Shinto shrines, dedicated to the imperial regalia sword Kusanagi. The easiest approach is via Jingu-mae Station on the Meitetsu Nagoya Main Line, or Jingu Nishi Station on the Nagoya Municipal Subway Meijo Line — both put you within a short walk of the shrine's southern approach, with the restaurant just beyond.

If arriving from Nagoya Station, the Meitetsu line is the more direct route (around 10–15 minutes), avoiding a subway transfer. Because the honten is tucked into a quiet, low-rise streetscape rather than a shopping arcade, it's worth confirming the exact walking route on a map app before setting out, since the building itself is unassuming from the street.
...
Combine the meal with Atsuta Jingu, which merits an hour or more for its forested approach, treasure hall, and side shrines — it's one of the most atmospheric shrine visits in the Nagoya area and sits essentially next door. Because the honten is a sit-down, traditional-style restaurant with tatami seating in parts of the building, it's better suited to a leisurely lunch than a quick bite between trains.

Cash and major payment methods are generally accepted at established restaurants of this caliber, but carrying some cash is still a sensible backup in case of system outages. If the wait looks discouraging, Hōraiken operates other branches around Nagoya (including one inside JR Nagoya Station) that serve the same hitsumabushi with shorter lines, though the honten remains the most historic setting.