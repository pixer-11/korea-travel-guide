...
It's not a manicured garden or a polished attraction. It's a working hillside with grass, dirt paths, and a scattering of nipa huts, which is exactly why the panorama feels earned rather than staged.
...
The main draw is the lookout point near the top, where a simple platform and a few benches frame the view. Bring a wide-angle lens if you have one; the whole bay curves into the frame at once.

Beyond the view, there are a few low-key activities worth your time:

- A zip line that runs across the hillside, with the city and coastline as backdrop
- Picnic huts and open grass areas for laying out food you've brought
