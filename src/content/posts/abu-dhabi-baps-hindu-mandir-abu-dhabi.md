...
Security screening is at the entrance, airport-style, and bags with cameras or large electronics may need to be checked. Phones are fine for photos in outdoor areas but usually restricted inside the main shrine hall.

Once inside, you move through:

- The main temple hall, where marble carving continues overhead in tight, repetitive patterns
- Shrines to multiple deities, each niche carved separately and set with its own idol
...
There's a food court and gift shop on-site, useful since you're a fair drive from central Abu Dhabi or Dubai. If you're combining this with other sights, it sits roughly midway between the two cities, making it an easy add-on to a highway transfer day rather than a dedicated round trip.
