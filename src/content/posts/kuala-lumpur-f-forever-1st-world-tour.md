...
heroImage:
  url: https://upload.wikimedia.org/wikipedia/commons/b/bb/BOYS_FOREVER_%2830107906903%29.jpg
  credit: 'Photo: Paul Hudson from United Kingdom / Wikimedia Commons (CC BY 2.0)'
  license: wikimedia
  source: https://commons.wikimedia.org/wiki/File:BOYS_FOREVER_(30107906903).jpg
  focus:
    x: 29
    'y': 35
    top: 8
...
F✦FOREVER is a genuine "supergroup" event for Mandopop and Taiwanese idol-drama fans: Jerry Yan, Van Ness Wu and Vic Chou, three-quarters of the legendary F4, teamed up with Ashin, frontman of Mayday, one of the biggest Mandarin rock bands of the last two decades. A lineup like this, spanning acting royalty and arena-rock songwriting, is the kind of one-off collaboration that doesn't tour often, which is why the Kuala Lumpur date on the group's 1st World Tour generated outsized buzz across Southeast Asia and Greater China fan communities.
...
Malaysian concertgoers tend to arrive early and treat the pre-show hours as part of the event (grabbing food at nearby malls, taking photos with tour banners, and queuing for official merchandise well before doors open. Payment inside the arena and at most KL malls is overwhelmingly cashless) cards and e-wallets (Touch 'n Go, GrabPay) are standard, though it's still common to carry a little cash for street-food stalls near Bukit Jalil.
