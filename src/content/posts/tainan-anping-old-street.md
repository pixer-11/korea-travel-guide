...
Anping rewards a half-day rather than a quick in-and-out. Fort Zeelandia — known locally as Anping Old Fort (Anping Guhua/古堡) — sits a short walk from the Old Street and is the direct physical remnant of the Dutch era that gives the street its name. From there it's an easy walk to the Anping Tree House, a former warehouse now swallowed by banyan roots, and to Anping Matsu Temple, one of the oldest Matsu temples in Taiwan. Treat the Old Street as the connective tissue between these sights rather than a standalone stop.
