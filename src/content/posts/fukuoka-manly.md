...
Fukuoka has no shortage of Instagram-ready pancake cafés, but Manly earns its 4.5-star rating (from nearly 1,500 reviews) by leaning fully into an Australian beach-town identity rather than the softer Japanese-Hawaiian style most local brunch spots chase. The name nods to Sydney's Manly Beach, and the menu backs it up with meat pies, hearty eggs, and stacked hotcakes rather than the ultra-light souffle pancakes Fukuoka is otherwise famous for.

The rustic, timber-heavy interior and handful of outdoor tables give it a laid-back, sun-washed feel that's distinct from the sleek minimalism of most Tenjin cafés — it's a good pick if you want brunch that feels like a destination rather than a quick stop.

## Getting there

Manly sits in Imaizumi, one chome south of the Tenjin core, at 1-chōme-18-55, inside a building called Tenjin Minami Royal Heights, ground floor. The closest station is Tenjin Minami on the Nanakuma Line (Fukuoka City Subway) — from there it's roughly a 5–7 minute walk east into the Imaizumi backstreets. If you're coming from the main Tenjin Station (Airport Line/Hakozaki Line) or the Nishitetsu Fukuoka (Tenjin) Station, it's closer to a 10–12 minute walk south through the Imaizumi shopping streets, which is a pleasant route past small boutiques and izakaya.

Imaizumi itself is known as a slightly more low-key, fashion-and-café district compared to the department-store bustle of central Tenjin, so the walk is part of the appeal.
...
Weekday mornings tend to be calmer, letting you claim one of the limited outdoor tables — a nice option in spring and autumn when Fukuoka's weather is mild enough to eat al fresco. Weekend brunch hours, especially Saturday late morning through early afternoon, draw the biggest crowds given the café's popularity and strong review count, so arriving right at opening or after 2pm is the better bet if you want to avoid a wait.

Summer in Fukuoka gets hot and humid, so the shaded indoor tables are more comfortable then; winter days are mild enough that the outdoor seating still works with a jacket. As with most independent cafés, always check current opening hours before heading over, since these can change seasonally.

## Nearby & tips

Imaizumi rewards lingering — after eating, wander the surrounding streets for small vintage shops, bakeries, and bars that don't get the tourist footfall of central Tenjin. It's an easy add-on to a day that includes Tenjin's shopping (Tenjin Underground Mall, Solaria Plaza) or a walk toward Fukuoka's Ohori Park, both within 15–20 minutes on foot or one subway stop. Because the café has both indoor and outdoor seating in a fairly compact space, larger groups may want to call ahead or expect a short wait even on weekdays.

Cash and card acceptance can vary at independent Fukuoka cafés, so carrying some yen as backup is a sensible habit.