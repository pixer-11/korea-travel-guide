...
The Han River park and its bike path run right alongside Yeouido Park, making it easy to extend a walk toward the river itself, and the 63 Building with its aquarium and observation deck is a short walk south — a natural add-on if you want an indoor stop before or after.
