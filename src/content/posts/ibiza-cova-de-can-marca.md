...
This is a well-known stop on the island's north-coast circuit, pulling coach parties and rental-car visitors alike, so it's rarely empty. Midday, especially in July and August, is when the entrance path and walkway feel most congested, with groups queueing at the narrower points inside. Aim for the first tour slots after opening or the later ones in the afternoon, when the light outside has softened and the coach groups have thinned. Spring and early autumn bring noticeably fewer visitors than peak summer while keeping the water at Sant Miquel swimmable.
