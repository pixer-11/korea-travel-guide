...
Ipoh runs hot and humid year-round, so early morning — before the sun climbs — or the couple of hours before sunset are the most comfortable windows, and they're also when the light does the most for the cliffs, catching them gold rather than flattening them under midday glare. This is a genuinely popular park with locals and visitors alike, not a quiet backwater, so expect real crowds on weekends and public holidays, with boat rental queues and packed lawns. Weekday mornings are your best shot at having a stretch of the path to yourself.
...
Gunung Lang pairs naturally with Ipoh's better-known cave temples — Perak Tong and Kek Look Tong are both within a short drive and share the same limestone-hill scenery, just with elaborate Buddhist shrines built into the cave mouths. Many visitors combine a morning at the caves with an afternoon at Gunung Lang, or vice versa, since all three sit on the same northern side of the city and make for an easy half-day loop before heading back into Ipoh's old town for its famous white coffee and street food.
