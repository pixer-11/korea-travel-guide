...
- Montjuïc's hill and castle across the city
- The geometric sprawl of Cerdà's Eixample grid below

Plan on 45 minutes to an hour, more if you linger for sunset.
...
This is a well-known stop on Barcelona's modern-architecture circuit, not a hidden find, so plan around the crowds rather than expecting to avoid them entirely.

- **Book ahead online.** Timed-entry tickets are standard here and the fastest way past the ground-floor line.
