...
Since you're already climbing Peel Street, treat Brunch Club as one stop on a SoHo morning rather than a standalone trip. Nearby options include:

- PMQ (former Police Married Quarters), a design and craft complex a short walk uphill
- The Central–Mid-Levels Escalator, the world's longest outdoor covered escalator system
- Man Mo Temple on Hollywood Road, a few minutes further west

Pair an early plate here with a walk through one of those before the midday heat and crowds build.
