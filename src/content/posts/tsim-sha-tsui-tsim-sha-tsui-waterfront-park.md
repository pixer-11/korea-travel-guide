...
The park runs along the water in Tsim Sha Tsui East, an easy walk from several MTR exits.

- **East Rail Line / Tsim Sha Tsui Station**: Exit J, then follow the underpass toward the harbour.
- **Star Ferry Pier**: if you're arriving from Central, the ferry ride itself is part of the experience, and the pier is a short walk south along the promenade.
- **Kowloon-Canton Railway clock tower**: a fixed landmark near the promenade's western end, useful for orienting yourself.
