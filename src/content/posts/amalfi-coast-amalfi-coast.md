...
Late spring (May–June) and early autumn (mid-September to October) give you warm sea temperatures, wisteria or fading-summer light, and towns that still function normally rather than existing purely to process visitors. July and August bring heat, packed ferries, and a coast road that can turn a 20-minute drive between towns into two hours. Winter is very quiet — many hotels and restaurants close — but the coast is still walkable and dramatically empty if that's what you want.
