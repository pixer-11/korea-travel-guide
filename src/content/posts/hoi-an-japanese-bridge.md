...
gallery:
  - url: >-
      https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Japanese_Bridge_in_Hoi_An.jpg/1920px-Japanese_Bridge_in_Hoi_An.jpg
...
quickAnswer: >-
  The Japanese Bridge (Chùa Cầu) is Hoi An's iconic 18th-century covered wooden
  bridge spanning a small canal off Nguyễn Thị Minh Khai Street in the heart of
  the Ancient Town. Visit right at opening (9am) or after sunset when lanterns
  light up the structure (it stays open until 10pm), and budget 15-20 minutes to
  see it plus the small shrine inside — entry requires the Hoi An Ancient Town
  heritage ticket. Combine it with a walk along the riverfront and nearby
  merchant houses since it sits right at the old town's western edge.
faq:
  ...
  - q: What's the best time to visit to avoid crowds?
    a: >-
      Arrive right at opening (around 9am) or come after sunset when lanterns
      are lit — the bridge stays open until 10pm. Midday and late afternoon see
      heavy tour group traffic.
