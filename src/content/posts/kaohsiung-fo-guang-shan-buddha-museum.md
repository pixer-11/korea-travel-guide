...
There's no MRT stop directly at the site, so budget extra time if you're relying on public transit rather than the shuttle.
...
The museum is closed every Tuesday, so plan around that. On other weekdays it runs 9am–6pm; Saturdays and Sundays it stays open until 7pm.
