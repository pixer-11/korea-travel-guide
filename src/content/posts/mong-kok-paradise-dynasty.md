...
faq:
  ...
  - q: When is the quietest time to visit?
    a: Both weekdays and weekends are calmest from around 11am onward into the afternoon. It's a reliably easier window for walk-in seating than evenings.
...
Beyond the rainbow basket, the menu runs deep into Sichuan-leaning and Shanghainese comfort dishes. A few worth flagging:

- La mian noodles hand-pulled to order, often in a spicy dan dan or beef broth style
- Truffle fried rice, a menu regular that pairs well with the dumplings
- Deep-fried spring onion pancake, crisp-edged and good for sharing
- Chilled cucumber salad with garlic, a palate reset between richer plates

Portions are built for sharing, so come with at least one other person and order across categories rather than doubling up on dumplings alone.

## When to go

Both weekdays and weekends stay calm from around 11am, which makes late morning through mid-afternoon the easiest window for a relaxed sit-down meal. The crunch comes later.
