...
Drivers should park at one of the peripheral lots (Fontebranda or San Francesco are common choices) and walk in, as the center is a restricted traffic zone.

## When to go

This is one of the most-visited sights in Tuscany, and it shows — tour groups from the coach parks can fill the nave by mid-morning. Early opening time, or the last hour or two before closing, are noticeably calmer, with softer light through the windows and room to actually stand back and take in the facade without a wall of raised phones in front of you.

Spring and fall bring the biggest crowds along with the best weather; a winter visit trades a few degrees of chill for a nearly empty piazza. Give yourself 90 minutes to two hours if you want to also see the Baptistery and crypt, which are usually included on combined tickets.

## How to visit like a local

Buy your ticket online before you arrive — the Opa Si Pass (covering the cathedral, crypt, baptistery, and Facciatone) is the standard way to see the full complex, and pre-booking avoids the ticket-office queue that forms on the piazza in peak season. Dress code is enforced: shoulders and knees covered for everyone, no exceptions, so bring a scarf or light layer even on a hot day.
