...
- Charter a private banca from El Nido's town beach or Corong-Corong, and ask the boatman specifically for Cadlao Lagoon (it's not on the standard lettered tour routes).
- Book a customized or "special" tour through a local operator, since most standard Island Hopping Tours A through D skip it entirely.
- Combine it with a visit to Cadlao Island's other coves if your boatman knows the coastline well.

Expect roughly 20–30 minutes of boat travel each way from town, depending on sea conditions.
...
Most visitors spend 30–60 minutes here before moving on to another stop on Cadlao or heading back to town.
...
Weekdays, it's quietest between 8pm and 9pm — though few boatmen run trips after dark, so treat this as a sign the daytime hours stay mild rather than a literal visiting window. On weekends, the calm stretches from 7am to 10pm, with the busiest crowds arriving between 9am and 4pm.
