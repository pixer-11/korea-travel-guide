...
heroImage:
  url: "https://upload.wikimedia.org/wikipedia/commons/8/88/Islamic_Arts_Museum_Malaysia_Exterior_%28May_2022%29_-_img_02.jpg"
...
place:
  ...
  busyness:
    ...
    weekendQuiet:
      - 10
      - 17
    venueId: "ven_7758352d423079315637695245447a4a6c7371717136714a496843"
tags:
  - "kuala lumpur"
  - "museum"
...
The museum sits inside the Perdana Botanical Gardens (formerly Lake Gardens), on Jalan Lembah near Tasik Perdana.

- Nearest station: Pasar Seni or Kuala Lumpur (KL Sentral), then a short taxi or Grab ride into the gardens
- By car: parking is available on-site, useful since the gardens are spread out and walking in from the road takes time
- On foot: it connects to the National Mosque (Masjid Negara) and KL Bird Park via garden paths, so many visitors combine all three in one outing
...
- The Architecture Gallery, with scale models of the Taj Mahal, Dome of the Rock, and Alhambra
...
The museum is open daily from 9:30am to 6pm, with no weekly closing day, which makes it flexible to slot into a Kuala Lumpur itinerary.
...
Because this is a well-visited, well-reviewed museum rather than a quiet find, the smartest move is timing your visit around the crowds rather than expecting to dodge them entirely.
