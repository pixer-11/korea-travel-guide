...
Two decades on, the three were scheduled to tour together again, and Bangkok was set for two full nights of it. That the city was picked as an early stop says something about how deep Meteor Garden's footprint runs here — Thai broadcasters aired and re-aired the drama for years, and its influence is visible in the wave of Thai dramas ("Y" and otherwise) that followed.

The bonus: Ashin, frontman of Mayday, one of the biggest Mandarin-rock acts of the last thirty years, was announced as special guest, which was set to turn this from a nostalgia set into something closer to a genuine multi-generational Mandopop event.
...
IMPACT Arena is one of Bangkok's larger indoor concert venues, built for exactly this kind of touring pop and drama-adjacent spectacle — expected to feature tiered seating, a general floor/standing zone in front of the stage for higher-tier tickets, and the kind of production values (screens, lighting rigs, staging) typical of major Mandopop arena tours. With two nights announced, this was being treated as a proper tour stop rather than a one-off appearance, so a full show rather than a short meet-and-greet format was expected.

Merchandise booths, photo opportunities tied to the tour branding, and pre-show queuing areas are standard at IMPACT for events of this scale, though specifics for this show hadn't been detailed publicly beforehand.

## Tickets and timing

Given this was a first-stop reunion date, tiered pricing (standing floor, numbered seating, VIP packages) was expected, similar to past F4-member solo tours and Mayday's own Bangkok arena shows. Because Bangkok often functions as a launch city for Mandopop tours reaching Southeast Asian audiences, tickets for reunion-scale shows like this one tend to move fast — regional fans frequently fly in specifically for the first dates of a tour.
...
Locals dress comfortably rather than glamorously for arena shows here — it's a long stand-or-sit night, and Bangkok's heat and humidity in early August make breathable clothing more useful than a fully coordinated outfit. Payment at food and merch stalls around IMPACT is largely cashless (cards and mobile wallets like PromptPay are widely accepted), though carrying some cash is still sensible for smaller vendors.

The most common visitor mistake is underestimating the Muang Thong Thani commute — arrive well before the stated door time, not showtime, since security screening and the sheer scale of the venue add up.
