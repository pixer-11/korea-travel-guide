...
You'll spot the open kitchen before you spot a table. Through a glass wall, cooks in white caps weigh dough on small scales, fold dumpling skins with sixteen to eighteen pleats, and load bamboo steamers onto racks that seem to multiply by the minute.
...
If you can only come at lunch, arrive right at 11am. You'll beat the first wave of shoppers and office workers by minutes, not hours.

## The wait, and how it works

Din Tai Fung doesn't take phone reservations at most Singapore branches, including this one. You queue, take a number, and wait for a buzzer or your name to be called.

Groups of two often move faster than groups of four or more, since the dining room is dense with small tables. If the wait board shows 30+ minutes, use the time to browse Paragon's ground floor rather than stand in the doorway.
