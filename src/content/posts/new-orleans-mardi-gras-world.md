...
This is a well-known, well-visited attraction rather than a quiet find, so the real skill is timing and logistics rather than discovery. Book your tour slot in advance online if you can — walk-ups are accepted, but pre-booking guarantees you a spot on the hour you want and skips any line at the desk. Tours run on a fixed schedule, so ask what time the next one departs when you arrive rather than assuming you can just wander in; entry is tour-guided, not self-directed. Most visitors pay by card at the counter, and there's no tipping expectation for the tour guides beyond the usual U.S. norm of a few dollars if a guide goes out of their way. The mistake first-timers make is treating this as a quick photo stop — the tour itself, workshop floor included, easily fills an hour, and if you linger in the gift shop and costume area afterward you can stretch a visit past ninety minutes. Combine it with a riverfront walk toward the Convention Center or Spanish Plaza afterward, since you're already down by the water and the walk back into the Warehouse District's galleries and restaurants is flat and scenic.
