---
title: 'Noush: Barcelona Travel Guide'
description: 'Noush in Barcelona, Spain — a new/trending spot: what it is, where it is, and how to visit.'
country: Spain
region: Barcelona
category: hidden-gem
pubDate: '2026-08-19'
...
tags:
  - barcelona
  - new & trending
quickAnswer: Noush is a small plant-based Persian restaurant in Barcelona's Sants neighborhood, opened recently and already drawing locals for its stews, herby rice, and comforting vegan takes on Persian classics. It's not on the tourist circuit yet, so go for a relaxed, low-key meal rather than a bucket-list photo op. Confirm current hours and whether reservations are accepted before you head over, since details are still settling as a new opening.
faq:
  - q: How do I get to Noush by public transport?
    a: Take Metro Line 3 or Line 5 to Sants Estació, then walk into the surrounding Sants neighborhood streets.
  - q: Do I need a reservation?
    a: It's a small, newly opened restaurant generating local buzz, so booking ahead is a good idea if they take reservations — call or check their online listing before you go.
  - q: Is the menu fully vegan?
    a: Yes, Noush reworks Persian classics like stews and herbed rice into plant-based versions, though exact current dishes should be confirmed on site or via their listed menu.
  - q: What's the best time to visit?
    a: An early weeknight dinner is a safe bet for a newer spot, before weekend word-of-mouth crowds build; confirm current opening hours before heading over since they may still be settling.
  - q: What else is nearby?
    a: Parc de l'Espanya Industrial is a short walk away, and Montjuïc's museums, gardens, and viewpoints are reachable by a short walk or metro ride from Sants Estació.
aiGenerated: true
draft: true
---

## Why Noush is worth the detour
...
Sants-Estació is the anchor of the neighborhood, served by Barcelona Metro Line 3 (green) and Line 5 (blue), plus regional and high-speed rail. From the station, the restaurant is within easy walking distance of the surrounding streets.

- Nearest metro: Sants Estació (L3/L5)
- Neighborhood: Sants, west of Plaça Espanya and Montjuïc
- Good to pair with: a walk through Parc de l'Espanya Industrial, or an evening arrival/departure at the station itself
