...
tags:
  - goyang
  - event
quickAnswer: 'BIGBANG was set to play three stadium shows at Goyang Stadium on August 21–23, 2026, as part of their "XX: COSMOS" world tour marking 20 years since debut. Nearest access is via Wonheung Station (Seoul Subway Line 3).'
faq:
  - q: When exactly is the Goyang leg of the tour?
    a: BIGBANG's three shows were scheduled for August 21, 22, and 23, 2026, at Goyang Stadium.
  - q: How do I get to Goyang Stadium?
    a: Seoul Subway Line 3 runs to Wonheung Station, the closest stop to the stadium, with signage and crowd-flow routing leading from there. From Incheon Airport, the AREX line and airport buses connect into Seoul, where transfers continue toward Goyang.
  - q: Where can I buy tickets?
    a: No ticketing platform or price was named in the announcement. Tours of this scale in Korea sell through a major Korean ticketing platform, with fan-club presale phases ahead of general sales.
  - q: Is this really the full BIGBANG lineup?
    a: Yes — G-Dragon, Taeyang, and Daesung were confirmed for this tour, their first full-group world tour in nine years, timed to their 20th anniversary.
  - q: How long should I plan to be at the venue?
    a: A stadium night here fills an entire evening. Merchandise and lightstick pickup draw fans to the plaza hours before doors, and a venue of this size empties slowly, so the exit is crowded and unhurried.
aiGenerated: true
draft: false
eventRecurring: false
photoless: true
heroImage:
  url: https://upload.wikimedia.org/wikipedia/commons/a/aa/BIGBANG_Concert_0.TO.10_in_Seoul.jpg
  credit: 'Photo: daissue / Wikimedia Commons (CC BY 4.0)'
  license: wikimedia
  source: https://commons.wikimedia.org/wiki/File:BIGBANG_Concert_0.TO.10_in_Seoul.jpg
  focus:
    x: 50
    'y': 50
---
