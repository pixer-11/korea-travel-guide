...
heroImage:
  url: https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/El_Rinconcillo_-_Plaza_los_Terercos_-_Seville_%2814678492295%29.jpg/1920px-El_Rinconcillo_-_Plaza_los_Terercos_-_Seville_%2814678492295%29.jpg
...
Start with the classics rather than improvising: espinacas con garbanzos (spinach stewed with chickpeas, cumin, and a little paprika) is the dish most associated with the house, alongside a cold, garlicky salmorejo in summer and a well-built plate of jamón and cured sausages carved right at the counter. The kitchen also does a respectable oxtail (rabo de toro) and classic fried fish, and the wine list — genuinely extensive, with a strong sherry selection — is worth asking the bar staff about rather than defaulting to the house red. Portions are built for sharing tapas-style among a few people rather than one dish per person.
...
Pair a stop here with a walk up to the Alameda de Hércules for its own bar-hopping scene, or fold it into a Casco Antiguo day that takes in the Cathedral, Giralda, and the Metropol Parasol — all within easy walking distance, so you can arrive hungry after sightseeing rather than detouring specially.