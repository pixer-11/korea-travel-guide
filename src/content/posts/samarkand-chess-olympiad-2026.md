...
description: Chess Olympiad 2026 in Samarkand, Uzbekistan — September 15-27, 2026. What it is, when and where, and how to plan around it.
country: Uzbekistan
region: Samarkand
category: event
pubDate: '2026-08-19'
...
eventRecurring: true
eventOrganizer:
  name: International Chess Federation (FIDE)
  url: https://www.fide.com
heroImage:
  url: https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Chess_Olympiad_Team_of_Uzbekistan_%2845th_Chess_Olympiad%29.jpg/3840px-Chess_Olympiad_Team_of_Uzbekistan_%2845th_Chess_Olympiad%29.jpg
  credit: 'Photo: MiroJP / Wikimedia Commons (CC BY-SA 4.0)'
  license: wikimedia
  source: https://commons.wikimedia.org/wiki/File:Chess_Olympiad_Team_of_Uzbekistan_(45th_Chess_Olympiad).jpg
gallery: []
tags:
  - samarkand
  - event
quickAnswer: The 46th Chess Olympiad runs September 15–27, 2026 in Samarkand, Uzbekistan, drawing around 200 national teams from across the globe. Exact venue halls, ticket prices, and the playing schedule haven't been finalized publicly at time of writing, so confirm details on FIDE's official Olympiad site before booking flights or hotels. Samarkand's compact historic core means you can combine chess-watching with Registan and Gur-e-Amir visits in the same afternoon.
faq: []
aiGenerated: true
draft: true
heldReason: content
...
Samarkand International Airport takes direct flights from several regional hubs, and a high-speed Afrosiyob train connects the city to Tashkent in under two hours. Most visitors base themselves near the old city, walking distance from the Registan ensemble.

The tournament venue itself hadn't been publicly finalized in detail at the time of writing. Large international events like this typically use a purpose-built or converted congress/exhibition center, so:

- Check FIDE's official Olympiad website for the confirmed venue address
- Re-check nearer the date, as team hotels and satellite venues often get added
- Expect the venue to sit somewhat outside the historic core, given the space large Olympiads require
...
Mid-to-late September in Samarkand means warm days, cooling evenings, and none of summer's punishing heat. It's a comfortable stretch for walking the old city between rounds.

Book accommodation early. An event pulling in players, delegations, and journalists from roughly 200 countries will squeeze the city's hotel supply, especially anything near the historic center.
