...
Dakeng sits inland from central Taichung, roughly a 30–40 minute taxi or scooter ride, and there's no MRT line out here — this is very much a drive-or-bus destination. Local buses run from Taichung's downtown area toward Dakeng, but schedules are infrequent and confirming the current route number before you go will save you a wasted wait. Most visitors rent a scooter or grab a taxi, both of which drop you at the trailhead cluster near Lane 383, Section 1, Dongshan Road — this lane is the spine of the whole scenic area, lined with small parking lots, fruit stands, and the shops that rent hiking poles and gloves.
...
Toilets and basic snack stalls cluster near the main trailheads on Dongshan Road, but once you're a few hundred meters up any given trail, facilities disappear — plan accordingly. Phone signal gets patchy in the deeper forested sections, so screenshot a trail map rather than relying on live data.