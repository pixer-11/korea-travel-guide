---
title: 'Casa Lavanda: Istanbul Travel Guide'
description: 'Casa Lavanda in Istanbul, Turkey — a new/trending spot: what it is, where it is, and how to visit.'
country: Turkey
region: Istanbul
category: hidden-gem
pubDate: '2026-07-29'
heroImage:
  url: https://images.unsplash.com/photo-1589561454226-796a8aa89b05?ixid=M3wxMDAyOTkyfDB8MXxzZWFyY2h8Mnx8SXN0YW5idWwlMjBUdXJrZXl8ZW58MHwwfHx8MTc4NTM2MjkzM3ww&ixlib=rb-4.1.0&w=1600&q=80&fm=jpg&fit=max
  credit: Photo by Engin Yapici on Unsplash
  license: unsplash
  source: https://unsplash.com/@yapici?utm_source=korea_travel_guide&utm_medium=referral
gallery: []
tags:
  - istanbul
  - new & trending
quickAnswer: Casa Lavanda is a farm-to-table restaurant in Ulupelit village, up in the forested hills of Şile on Istanbul's Black Sea coast — roughly a 90-minute drive from the city center. Chef Emre Şen holds both a Michelin Red Star and a Green Star for sustainability here, cooking dishes built around a garden that supplies about 80% of the vegetables you'll eat. Book ahead, plan for a half-day trip out of the city, and confirm hours directly before you set off, since this is a destination restaurant with limited seatings.
faq:
  - q: How do I get to Casa Lavanda from central Istanbul?
    a: There's no direct public transit — most visitors drive or hire a car for the day. Expect roughly 70–90 km and well over an hour each way from central Istanbul out to Ulupelit village in Şile.
  - q: Do I need a reservation?
    a: Yes. As a restaurant holding both a Michelin Green Star and Red Star, seating is limited, so book ahead and reconfirm before making the drive — don't arrive unannounced.
  - q: What kind of food does Casa Lavanda serve?
    a: Farm-to-table cooking led by chef Emre Şen, with around 80% of vegetables coming from the restaurant's own organic garden. The menu follows the harvest, so expect it to change seasonally rather than looking up a fixed menu in advance.
  - q: How long should I plan for the visit?
    a: 'Treat it as a half-day to full-day trip: 90 minutes or so each way plus a couple of hours at the table for a considered, multi-course meal. Many visitors combine it with a stop in Şile town itself.'
...
Late spring through early autumn is when a garden-driven kitchen like this shows its range, with the harvest at its most varied and the surrounding hillsides of Şile at their greenest. Weekday visits, if the restaurant's schedule allows them, tend to mean a calmer dining room and more attention from the kitchen than a weekend when demand for a limited number of tables is highest.
