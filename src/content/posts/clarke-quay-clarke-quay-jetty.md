...
After the jetty, cross Read Bridge to browse Clarke Quay's restaurant blocks, or walk toward Fort Canning Park (accessible via a short uphill path from River Valley Road) for a green, elevated counterpoint to the river-level scene. Boat Quay's older shophouse bars are a 10-minute walk east if you want to compare the two quays' very different atmospheres after dark.
