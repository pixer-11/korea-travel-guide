---
title: 'YAPA: Milan Travel Guide'
description: 'YAPA in Milan, Italy — a new/trending spot: what it is, where it is, and how to visit.'
country: Italy
region: Milan
category: trendy
pubDate: '2026-08-05'
tags:
  - milan
  - new & trending
quickAnswer: YAPA is a fusion restaurant-bar on Viale Monte Nero in Milan's Porta Romana/Corso di Porta Vittoria area, built around chef Matteo Pancetti's "Nomadic Soul" concept — Japanese robatayaki grilling meets South American flavors, paired with a globally-minded cocktail list. It's best visited in the evening for the grill-and-cocktails combo, ideally with a reservation since it's a buzzy, recently expanded space. Confirm current hours and book ahead, as details shift with its fast-growing profile.
faq:
  - q: Where exactly is YAPA located?
    a: On Viale Monte Nero in Milan, in the area between Porta Romana and Corso di Porta Vittoria, southeast of the Duomo — reachable by tram along the viale or a short walk/metro ride from Porta Romana (Line 3) or San Babila (Line 1).
  - q: Do I need a reservation?
    a: It's strongly recommended. YAPA has built a buzzy reputation around its robatayaki grill and guest-bar cocktail collaborations, so booking ahead is safer than walking in, especially on weekend evenings.
  - q: What's the concept — is it Japanese or South American food?
    a: 'Both, blended: chef Matteo Pancetti''s ''Nomadic Soul'' concept combines Japanese robatayaki grilling technique with South American flavor influences, plus a globally inspired cocktail list.'
  - q: What is 'Liquid Diaries'?
    a: It's YAPA's ongoing collaboration series bringing in international guest bars — including New York's Double Chicken Please — to create limited-run cocktails, so the drink menu changes periodically.
...
Because YAPA functions as both a dinner spot and a cocktail destination, evenings are clearly the point — this is not a lunch-counter kind of place given its grill-and-cocktail identity. Given its recent expansion and its collaboration series drawing attention from Milan's cocktail crowd, weekend nights are likely to be the busiest; if you want a calmer conversation-friendly evening, an early weeknight visit is the safer bet. Always confirm current opening hours and whether a reservation is required before you go, since details at fast-rising, recently launched venues change often.
