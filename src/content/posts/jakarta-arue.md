---
title: 'ARUÉ: Where to Eat in Jakarta'
description: 'ARUÉ in Jakarta, Indonesia — a new/trending spot: what it is, where it is, and how to visit.'
country: Indonesia
region: Jakarta
category: restaurant
pubDate: '2026-08-27'
...
tags:
  - jakarta
  - new & trending
quickAnswer: ARUÉ is a newly opened restaurant in Blok M, South Jakarta, near The Trunojoyo, that's become one of the city's buzziest 2026 hangout spots for coffee, catching up, or a comforting bowl of Thai beef noodle. It sits within easy reach of TransJakarta's CSW stop and MRT Asean station, so it works well as an after-work or weekend meeting point. Confirm current hours and whether reservations are needed before you go, since details can shift fast at a place this new.
faq:
  - q: Where exactly is ARUÉ located?
    a: It's in Blok M, South Jakarta, near the Trunojoyo area — a leafy, walkable pocket known for cafés and older colonial-era streets.
  - q: How do I get to ARUÉ by public transport?
    a: Take TransJakarta to the CSW stop or the MRT to ASEAN station; both are within an easy walk of the restaurant.
  - q: What's the signature dish?
    a: The Thai beef noodle is the dish most regulars order first, part of ARUÉ's broader comforting, Indonesian-inspired menu.
  - q: Do I need a reservation?
    a: As a newly opened, buzzy spot, tables can fill up on weekend evenings — check with the restaurant directly for current reservation policy and hours before heading over.
  - q: When is the best time to visit for a quiet meal?
    a: Early evening on weekdays tends to be calmer, before the after-work and weekend crowds settle in for longer hangouts.
aiGenerated: true
draft: true
---
...
The draw is the mood as much as the menu. ARUÉ leans into a comforting, Indonesian-inspired kitchen, and its Thai beef noodle has become something of a calling card among regulars.

It's the sort of dish people order on autopilot, then linger over for another hour of coffee and conversation. That lingering is really the point of the place.

## Finding it near The Trunojoyo
...
Public transit makes this an easy add to a Jakarta day out.
