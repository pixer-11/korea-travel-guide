---
title: 'Xava Skybar: Singapore Travel Guide'
description: 'Xava Skybar in Singapore, Singapore — a new/trending spot: what it is, where it is, and how to visit.'
country: Singapore
region: Singapore
category: trendy
pubDate: '2026-08-05'
...
tags:
  - singapore
  - new & trending
quickAnswer: Xava Skybar sits atop the National Gallery Singapore, a 7,000-square-foot rooftop with unobstructed views over Marina Bay, indoor and open-air seating, and a menu that runs from Wagyu Tataki to signature cocktails. It officially opened August 1, 2026, so it's still very new — book ahead, arrive before sunset for a table with a clear skyline view, and confirm current hours and reservation policy directly with the venue before you go.
faq:
  - q: How do I get to Xava Skybar?
    a: It's on top of the National Gallery Singapore in the Civic District, an easy walk from City Hall MRT station (North-South and East-West lines) or Raffles Place MRT.
  - q: Do I need a reservation?
    a: As a brand-new, high-visibility rooftop with unobstructed Marina Bay views, booking ahead is strongly recommended, especially for a rail-side table at sunset. Confirm the current reservation process directly with the venue.
  - q: What's the best time to visit for the view?
    a: Aim to arrive in the hour before sunset so you get natural light fading into the illuminated Marina Bay skyline. Exact opening hours should be confirmed before you go, since the bar only opened August 1, 2026.
  - q: What kind of food and drinks does it serve?
    a: An international small-plates style menu including dishes like Wagyu Tataki, paired with a list of signature cocktails rather than standard classics.
  - q: What else can I see nearby?
    a: You're inside the National Gallery Singapore building, so combine your visit with the museum's Southeast Asian art collection, then walk to Merlion Park, the Helix Bridge, or the Esplanade waterfront afterward.
aiGenerated: true
draft: true
---
...
This is a sunset bar by design — the entire draw is the unobstructed sightline over Marina Bay, and that view performs best in the hour before dusk, when the skyline starts lighting up and the sky still holds some color. Because it only opened in August 2026, exact opening hours and how far ahead you need to book aren't yet settled enough to print with confidence here — check the Gallery's or the bar's own listing shortly before your visit, since new venues in Singapore often adjust their hours in the first months of operation.
...
Because you're already inside the National Gallery Singapore building, it's worth pairing the bar with time in the galleries themselves beforehand — the museum houses the world's largest public collection of Singapore and Southeast Asian modern art. Afterwards, the Marina Bay waterfront promenade, Merlion Park, and the Helix Bridge are all within a comfortable walk if you want to see that skyline from ground level too.