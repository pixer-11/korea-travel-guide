...
description: サンタ・イグレシア・カテドラル・バシリカ・デ・ラ・エンカルナシオン・デ・マラガは、二本目の塔が未完成のまま残されていることから地元で「ラ・マンキータ(片腕の女性)」と呼ばれ、ディストリト・セントロのモリナ・ラリオ通り(Calle Molina Lario)に建っています。評価4.6★(レビュー36,946件)、訪問者の声や営業時間、訪問のコツをまとめました。
