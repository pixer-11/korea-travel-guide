...
description: ロンボク・バラット県リンサール郡バトゥ・クンブン村にあるプラ・リンサールは、1741年に建立されたロンボク島最古にして最重要の共有寺院です。バリ・ヒンドゥー教徒とササック族のウェトゥ・テル・ムスリムの双方が礼拝する場所として知られています。4.3★(496件のレビュー)—訪問者の声、営業時間、訪問のコツをご紹介します。
