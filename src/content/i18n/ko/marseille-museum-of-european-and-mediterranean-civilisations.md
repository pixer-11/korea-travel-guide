...
description: 비외포르(Vieux-Port) 쪽 입구에서 J4 에스플러네이드로 이어지는 길을 따라 MuCEM(Musée des Civilisations de l'Europe et de la Méditerranée)에 가보세요. 박물관이 저녁 개장을 하는 오후 6시~9시대를 노리면 평일과 주말 모두 가장 한산합니다. 4.4★(리뷰 24,692개) — 방문객 후기, 운영시간, 팁을 소개합니다.
