...
description: 말라가 산타 이글레시아 카테드랄 바실리카 데 라 엔카르나시온은 두 번째 탑을 끝내 완성하지 못해 현지에서 "라 만키타(외팔이 여인)"라 불리며, 센트로 지구(Distrito Centro)의 몰리나 라리오 거리(Calle Molina Lario)에 자리하고 있습니다. 평점 4.6★(리뷰 36,955건) — 방문객들의 후기와 운영시간, 팁을 소개합니다.
