...
description: 라 페드레라(카사 밀라, La Pedrera - Casa Milà)는 파세이그 데 그라시아(Passeig de Gràcia) 92번지에 위치한 가우디의 물결치는 석조 아파트 건물로, 매일 오전 9시부터 밤 11시까지 문을 엽니다 — 주말 오전 11시부터 오후 7시 사이에 몰리는 인파를 피해 물결치는 옥상 테라스와 다락을 여유롭게 걸으려면 오전 9시 또는 오후 7시 이후에 방문하세요. 4.6★ (리뷰 113,490개) — 방문객 평가, 운영시간, 방문 팁을 확인하세요.
