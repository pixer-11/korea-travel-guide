...
faq:
  - q: ¿Cuánto tiempo debo reservar para Mini Siam?
    a: Calcula entre 1,5 y 2 horas para recorrer todo el terreno con tranquilidad; añade tiempo extra si visitas con niños o quieres quedarte hasta el atardecer para ver las réplicas iluminadas.
  - q: ¿Cómo llego a Mini Siam sin auto de alquiler?
    a: Toma un Grab o un taxi con taxímetro (unos 10-15 minutos desde el centro de Pattaya) o detén un songthaew azul en Sukhumvit Road y pide que te dejen en Mini Siam; está justo sobre la carretera principal.
  - q: ¿Cuál es el mejor momento del día para visitarlo?
    a: 'A última hora de la tarde, aproximadamente entre las 4 y las 5 pm, es lo mejor: tienes luz natural para las fotos al principio y puedes quedarte para ver varias réplicas iluminadas después del anochecer.'
  - q: ¿Hay comida disponible en el lugar?
    a: Sí, hay una cafetería en el propio recinto para bebidas y snacks, aunque es recomendable llevar también agua, ya que las zonas con sombra entre las exhibiciones son limitadas.
  - q: ¿Es Mini Siam bueno para niños?
...
El parque se encuentra en 387 Sukhumvit Road, en Muang Pattaya, justo sobre la carretera, lo que facilita el acceso pero impide llegar a pie desde la vía principal de la playa (Beach Road) o desde Walking Street; calcula entre 10 y 15 minutos en auto desde el centro de Pattaya, según el tráfico.

- **En taxi/Grab:** La opción más sencilla; un taxi con taxímetro o un viaje en Grab desde el centro de Pattaya o Jomtien tiene una tarifa corta y económica.
- **En songthaew (baht bus):** Los songthaews azules compartidos circulan por Sukhumvit Road; detén uno y pide que te lleve a "Mini Siam", luego camina un corto tramo hasta la entrada frente a la carretera.
- **En auto/motocicleta:** Hay estacionamiento en el propio recinto, y como la atracción da directamente a Sukhumvit Road, es una parada sencilla si viajas entre Pattaya y Bangkok o te diriges hacia Naklua.

Como está sobre la carretera y no en una zona peatonal, conviene planearlo como un viaje específico y no como algo con lo que te encuentras por casualidad.

## Qué ver y hacer

Calcula entre 1,5 y 2 horas para recorrer el terreno con calma, más tiempo si viajas con niños que quieran subir a las plataformas de observación o tomarse fotos con cada maqueta. Lo más destacado que priorizar:

- **Réplicas de Wat Arun y el Gran Palacio** — las más detalladas y fotogénicas de la sección tailandesa, útiles si aún no has visitado los originales en Bangkok.
- **Maqueta del Puente sobre el Río Kwai** — un guiño al histórico puente ferroviario de Kanchanaburi.
- **Conjunto de monumentos europeos** — la Torre Eiffel, la Torre Inclinada de Pisa y el Tower Bridge están muy próximos entre sí, ideales para una secuencia rápida de fotos de "vuelta al mundo".
- **Réplica de Angkor Wat** — una de las maquetas más grandes y elaboradas, en representación de la vecina Camboya.

El parque también cuenta con una cafetería en el propio recinto donde puedes hacer una pausa para tomar bebidas frías o algún snack, algo útil con el calor de Pattaya, ya que hay poca sombra entre los grupos de maquetas. Usa sombrero y protector solar, y lleva agua aunque exista la cafetería.
