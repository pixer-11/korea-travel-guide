...
faq:
  - q: ¿Con cuánta antelación debo reservar en OSA?
    a: Lo antes posible, idealmente en el momento en que tengas fechas de viaje a Madrid confirmadas. Es una de las aperturas más comentadas de la ciudad en los últimos tiempos, y las mesas de chefs con trayectoria en Mugaritz suelen reservarse con mucha antelación.
  - q: ¿Qué tipo de comida sirve OSA?
    a: Espera una experiencia de autor tipo menú degustación, arraigada en ingredientes españoles pero moldeada por el enfoque más experimental y centrado en la técnica que ambos fundadores desarrollaron en Mugaritz, en lugar de una carta clásica de tapas.
  - q: ¿Necesito hablar español para reservar o cenar allí?
    a: No necesariamente; muchos de los restaurantes más solicitados de Madrid gestionan las reservas online y cuentan con personal acostumbrado a atender a comensales internacionales. Aun así, revisa las opciones de idioma de la plataforma de reservas al hacer tu reserva.
  - q: ¿Debo confirmar el horario antes de ir?
    a: 'Sí: consulta el sitio web oficial de OSA o su canal de reservas poco antes de tu visita. Los horarios y las ventanas de reserva en restaurantes nuevos y muy demandados pueden cambiar a medida que evoluciona el ritmo de la cocina.'
  - q: ¿Se puede entrar en OSA sin reserva?
    a: En la práctica, trátalo como un restaurante solo con reserva. Dada su popularidad, presentarse sin reserva conlleva un riesgo real de que te rechacen, especialmente en las noches de fin de semana.
---
...
OSA se encuentra en pleno Madrid y, como la mayoría de los restaurantes de referencia en el centro de la ciudad, es perfectamente accesible en metro o a pie desde los barrios circundantes, con los taxis y las apps de VTC como alternativa sencilla si vienes de más lejos o prefieres no lidiar con transbordos después de cenar. Como la dirección exacta y la salida de metro más cercana son el tipo de detalle que es fácil equivocar de segunda mano, busca la dirección actual de OSA en Google Maps o en la web del propio restaurante justo antes de salir del hotel: trátalo como el primer paso de la noche, no como algo secundario.
