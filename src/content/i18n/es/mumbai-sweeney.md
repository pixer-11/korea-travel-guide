...
faq:
  - q: ¿Dónde está exactamente Sweeney?
    a: Está en Ballard Estate, dentro de la zona de Fort de Mumbai — un distrito comercial patrimonial justo al norte de la Chhatrapati Shivaji Maharaj Terminus, al que se llega mejor en taxi, auto-rickshaw o caminando desde CST.
  - q: ¿Necesito reservar?
    a: Dado que es un restaurante recién inaugurado y de gran repercusión, se recomienda encarecidamente reservar con antelación, sobre todo para los horarios de noche y fin de semana. Llama o consulta sus canales de reserva antes de ir.
  - q: ¿Qué pasa con el árbol de mango?
    a: Un mango de aproximadamente 140 años cubre casi la mitad de la zona de asientos al aire libre, y según cuentan, el personal entrega a los comensales un frasco de mermelada de mango si un mango les cae encima mientras están sentados debajo.
  - q: ¿Qué debería pedir o esperar del menú?
    a: No se han podido confirmar detalles concretos del menú aquí — pregunta directamente al restaurante o consulta su oferta actual antes de visitarlo, ya que los menús de los locales recién abiertos cambian rápido.
  - q: ¿Qué más puedo hacer cerca?
    a: El propio Ballard Estate merece un paseo tranquilo por su arquitectura de principios del siglo XX bien conservada, y estás a poca distancia en coche de CST, Horniman Circle y el resto de los lugares de la época colonial del distrito de Fort.
---
...
Camina hasta la zona exterior y entenderás de inmediato la decisión de diseño. Un mango que se cree tiene unos 140 años extiende su copa sobre casi la mitad del área de asientos exterior, con ramas gruesas y retorcidas como solo puede tenerlas un árbol que ha sobrevivido a varias generaciones del edificio que lo rodea. Está claro que el diseño se pensó alrededor del árbol y no en su contra — las mesas se orientan para aprovechar la sombra, y la corteza y el follaje dan al espacio una luz tamizada y moteada que ningún presupuesto de interiorismo podría imitar. Es el tipo de detalle que llena el feed de fotos incluso antes de que llegue la comida.

Y luego está la peculiaridad de la que todos hablan: si un mango cae del árbol sobre tu mesa — o sobre ti — mientras estás sentado debajo, se dice que el personal te envía un frasco de mermelada de mango a modo de disculpa. Que esto te ocurra depende por completo de la temporada y de un poco de suerte, pero es el tipo de ritual pequeño y concreto que convierte a un restaurante en una historia que la gente repite a sus amigos incluso antes de haber ido.
...
Ya que estarás en el barrio, resérvate tiempo antes o después de tu reserva para pasear por el propio Ballard Estate — es una de las pocas zonas de Mumbai donde sobrevive intacto todo un distrito comercial de principios del siglo XX, y las calles tranquilas y de poco tráfico después del horario de oficina invitan a un paseo fácil y con mucho ambiente de vuelta hacia Fort o la zona de CST.
