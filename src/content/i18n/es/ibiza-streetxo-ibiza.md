...
faq:
  - q: ¿Dónde está exactamente StreetXO Ibiza?
    a: Se encuentra dentro de The Unexpected Ibiza Hotel. Confirma la dirección exacta y los detalles de acceso al reservar, ya que los restaurantes ubicados en hoteles a veces tienen una entrada separada del lobby principal.
  - q: ¿Necesito reserva?
    a: Sí — dado el perfil del chef Dabiz Muñoz (DiverXO, World's 50 Best), es probable que las mesas se agoten rápido durante el verano. Reserva lo antes posible a través de los canales oficiales del hotel.
  - q: ¿Qué tipo de comida sirve StreetXO?
    a: Es una versión de alta gama del street food global, que fusiona influencias asiáticas, latinoamericanas y mediterráneas con técnica de alta cocina, servida en torno a una barra central y una cocina abierta. Los platos y precios exactos no estaban confirmados al momento de escribir esto, así que conviene consultar la oferta actual directamente.
  - q: ¿Cuándo está abierto?
    a: Se plantea como un concepto de verano ligado a la temporada alta de Ibiza (aproximadamente de mayo a octubre). Los horarios y días de apertura específicos deben confirmarse con el hotel cerca de la fecha del viaje, ya que se trata de un local recién inaugurado.
  - q: ¿Cómo llego de noche?
...
- **Reserva directamente a través del hotel** cuando sea posible, ya que los nuevos lanzamientos de restaurantes a veces canalizan las reservas a través de la conserjería o la web del hotel antes de contar con un sistema de reservas independiente.
- **Siéntate en la barra si puedes** — la barra frente a la cocina abierta es la experiencia distintiva del formato y te sitúa lo más cerca posible de la acción.
- **Dosifica tu visita** — los formatos de degustación al estilo street food suelen implicar varios platos pequeños para compartir en lugar de un único plato principal, así que conviene ir preparado para pedir de forma progresiva en vez de elegir un solo plato fuerte.
- **Combínalo con una visita a Ibiza (Vila) o al puerto deportivo** — al tratarse de un local dentro de un hotel, conviene plantear la cena como el ancla de la noche e incluir en el día previo un paseo por el casco antiguo de Dalt Vila o por la marina.
- **Reconfirma todo cerca de la fecha de llegada** — los horarios, el código de vestimenta esperado y las ventanas de reserva de una apertura de verano recién estrenada son los detalles con más probabilidades de cambiar tras la cobertura de prensa inicial.
