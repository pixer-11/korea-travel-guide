...
faq:
  - q: ¿Cómo se llega al Ejército de Terracota desde el centro de Xi'an?
    a: Toma la Línea de Autobús Turístico 5 (You You 5 / Bus 306) desde la plaza este de la Estación de Tren de Xi'an (Xi'an Railway Station), o un taxi/Didi — ambos tardan aproximadamente 1.5 horas para el trayecto de 40km hasta el distrito de Lintong.
  - q: ¿Cuánto tiempo debo destinar a la visita?
    a: Planea entre 2.5 y 3.5 horas para ver las tres fosas y la sala de exhibición de las carrozas de bronce sin prisas; añade tiempo extra si también visitas el montículo funerario del emperador, cercano al sitio.
  - q: ¿Qué fosa debería ver primero?
    a: Ve primero las Fosas 2 y 3 para tener contexto sobre la excavación y la formación, y termina con la Fosa 1 — la más grande y visualmente impactante, con más de 6,000 guerreros en formación.
  - q: ¿Vale la pena contratar un guía?
    a: Sí — la señalización en el sitio es limitada dada la importancia del lugar, y un guía autorizado o una audioguía explican detalles como el desvanecimiento de la pintura original y por qué la tumba principal permanece sin excavar.
  - q: ¿Cuál es la mejor época del año y del día para visitar?
...
Hay tres fosas más una sala de exhibición, y el orden importa:

- La **Fosa 1** es el evento principal — una excavación del tamaño de un hangar con más de 6,000 guerreros dispuestos en formación de batalla, con columnas de infantería a los lados. Déjala para el final si quieres el mayor impacto visual, ya que es la más grande y la más restaurada.
- La **Fosa 2** muestra caballería, arqueros y oficiales en distintas etapas de excavación, incluyendo algunos guerreros aún parcialmente cubiertos de tierra — útil para entender cómo se realiza realmente la excavación.
- La **Fosa 3** es más pequeña, y se cree que fue un puesto de mando, con menos figuras pero una lógica de formación de batalla más intacta.
- La **Sala de Exhibición** muestra dos carrozas de bronce con caballos, exquisitamente detalladas, junto con guerreros individuales lo suficientemente cerca como para ver las uñas, los peinados y las armaduras que indican rango.

Calcula un mínimo de 2.5 a 3.5 horas para recorrer las tres fosas y la sala sin prisas. Un guía autorizado en el sitio (contratado en la entrada, distinto de los guías incluidos en los paquetes de tour) o una aplicación de audioguía aportarán contexto que los carteles no explican — en particular, por qué la pintura original de los guerreros se ha desvanecido en su mayoría y por qué el montículo real de la tumba del emperador, visible a la distancia, permanece sin excavar.
