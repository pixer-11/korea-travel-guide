...
faq:
  - q: ¿Hace falta reservar en la Posada Venta Pilar?
    a: Entre semana, cuando el ambiente es tranquilo, no es imprescindible, pero se recomienda encarecidamente reservar para las comidas de fin de semana y, sobre todo, en las fechas de la Tomatina a finales de agosto, cuando el restaurante se llena enseguida.
  - q: ¿Cómo se llega a Buñol sin coche?
    a: 'Basta con tomar el tren de Cercanías C-3 desde la estación de Valencia Nord: el trayecto dura menos de una hora, y desde la estación de Buñol el restaurante queda a 10-15 minutos a pie.'
  - q: ¿Qué conviene pedir?
    a: El plato estrella es el arroz al horno, y como entrantes suelen pedirse embutidos y quesos de la zona; conviene preguntar si ese día hay menú del día, que suele ser la opción más económica.
  - q: ¿Es un sitio para turistas o un lugar frecuentado por los vecinos?
    a: 'Se trata de una dirección muy conocida y concurrida, no de un hallazgo escondido: es habitual encontrar tanto a viajeros como a vecinos del lugar, y el ajetreo se dispara especialmente durante la Tomatina.'
